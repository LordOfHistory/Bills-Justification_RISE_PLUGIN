...
class Expenses_settings_model extends Crud_model {

    protected $table = null;

    function __construct() {
        $this->table = 'expenses_justification_settings';
    ...
    function get_all_settings() {
        $settings_table = $this->db->prefixTable('expenses_justification_settings');
